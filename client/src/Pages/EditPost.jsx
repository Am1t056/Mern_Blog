...
const EditPost = () => {
  ...
  const handleSubmit=async(e)=>{
    ...
    try {
      const response=await axios.patch(`${import.meta.env.VITE_BACKEND_URL}/posts/${id}`,postData,{withCredentials:true,headers:{Authorization: `Bearer ${token}`}})
      ...
      <div className="container">
       ...
       {error &&  <p className='form__error-message'>
        ...
        <form  className="form create-post__form" onSubmit={handleSubmit}>
             ...
             <button type='submit' className='btn primary'>Uodate</button>
        </form>
      </div>
   </section>
  )
